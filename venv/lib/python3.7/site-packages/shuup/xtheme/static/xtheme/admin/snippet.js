...
},{"../../lib/codemirror":"dg4e"}],"0AHj":[function(require,module,exports) {
var define;
var t;!function(e){"object"==typeof exports&&"object"==typeof module?e(require("../../lib/codemirror"),require("../fold/xml-fold")):"function"==typeof t&&t.amd?t(["../../lib/codemirror","../fold/xml-fold"],e):e(CodeMirror)}(function(t){"use strict";function e(t){t.state.tagHit&&t.state.tagHit.clear(),t.state.tagOther&&t.state.tagOther.clear(),t.state.tagHit=t.state.tagOther=null}function a(a){a.state.failedTagMatch=!1,a.operation(function(){if(e(a),!a.somethingSelected()){var o=a.getCursor(),i=a.getViewport();i.from=Math.min(i.from,o.line),i.to=Math.max(o.line+1,i.to);var r=t.findMatchingTag(a,o,i);if(r){if(a.state.matchBothTags){var n="open"==r.at?r.open:r.close;n&&(a.state.tagHit=a.markText(n.from,n.to,{className:"CodeMirror-matchingtag"}))}var c="close"==r.at?r.open:r.close;c?a.state.tagOther=a.markText(c.from,c.to,{className:"CodeMirror-matchingtag"}):a.state.failedTagMatch=!0}}})}function o(t){t.state.failedTagMatch&&a(t)}t.defineOption("matchTags",!1,function(i,r,n){n&&n!=t.Init&&(i.off("cursorActivity",a),i.off("viewportChange",o),e(i)),r&&(i.state.matchBothTags="object"==typeof r&&r.bothTags,i.on("cursorActivity",a),i.on("viewportChange",o),a(i))}),t.commands.toMatchingTag=function(e){var a=t.findMatchingTag(e,e.getCursor());if(a){var o="close"==a.at?a.open:a.close;o&&e.extendSelection(o.to,o.from)}}});
},{"../../lib/codemirror":"dg4e","../fold/xml-fold":"lhSK"}],"Kqv2":[function(require,module,exports) {
"use strict";var e=r(require("codemirror"));function r(e){return e&&e.__esModule?e:{default:e}}function t(e){return"inline_css"===e?"css":"inline_js"===e?"javascript":"htmlmixed"}require("codemirror/mode/javascript/javascript"),require("codemirror/mode/css/css"),require("codemirror/mode/htmlmixed/htmlmixed"),require("codemirror/addon/edit/closebrackets"),require("codemirror/addon/edit/closetag"),require("codemirror/addon/edit/matchbrackets"),require("codemirror/addon/edit/matchtags"),window.CodeMirror=e.default,e.default.editors={},window.addEventListener("load",function(){Array.from(document.getElementsByClassName("snippet-editor-textarea")).forEach(function(r){var o=null,i=$(r).closest("form").find("[name='snippet_type']");function a(i){o=e.default.fromTextArea(r,{mode:t(i),matchBrackets:!0,matchTags:!0,autoCloseBrackets:!0,autoCloseTags:!0,lineNumbers:!0}),e.default.editors[r.getAttribute("id")]=o}i.change(function(e){o&&o.toTextArea(),a(e.target.value)}),a(i.val())})});
},{"codemirror":"dg4e","codemirror/mode/javascript/javascript":"iTpz","codemirror/mode/css/css":"s7Nk","codemirror/mode/htmlmixed/htmlmixed":"Xs+7","codemirror/addon/edit/closebrackets":"76pM","codemirror/addon/edit/closetag":"RcYZ","codemirror/addon/edit/matchbrackets":"/5m6","codemirror/addon/edit/matchtags":"0AHj"}]},{},["Kqv2"], null)
